    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subсategories', to='shop.category', verbose_name='Категория')),
            ],
            options={
